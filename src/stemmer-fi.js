/* Finnish Snowball stemmer — self-contained ES module.
 *
 * Snowball algorithm (finnish.sbl) by Martin Porter / Richard Boulton, BSD-3-Clause:
 *   https://snowballstem.org/algorithms/finnish/stemmer.html
 * JavaScript generated form and Snowball runtime vendored from @nlpjs/core and
 * @nlpjs/lang-fi v4.26.1, Copyright (c) AXA Group Operations Spain S.A., MIT licence.
 *
 * Muokkaukset: nlp.js:n container-, tokenizer- ja sanakirjariippuvuudet poistettu,
 * CommonJS muunnettu ES-moduuliksi. Algoritmin logiikkaan ei ole koskettu.
 *
 * MIT-lisenssi edellyttää yllä olevan tekijänoikeusilmoituksen säilyttämistä.
 */

class Among {
  constructor(s, sub, result, method, instance) {
    this.s_size = s.length; this.s = s; this.substring_i = sub;
    this.result = result; this.method = method; this.instance = instance;
  }
}
...
const _fi = new StemmerFi();
/** Palauttaa suomenkielisen sanan vartalon. Syöte pienaakkosiksi kutsujan vastuulla. */
export function stemFi(word) { return _fi.stemWord(word); }
export { StemmerFi };
